...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/novomenu.css" />
                ...
                <?php if ($_SESSION["logged_in"] == true) { ?>
                    ...
                    <div class="mainmenu">
                        <ul>
                            ...
                            <li>
                                <ul class="dropdown">
                                    <li class="dropbtn">Configurações</li>
                                    <div class="dropdown-content">
                                        <a href="bs-settings.php">PayPal</a>
                                        <a href="bs-pixsettings.php">Pix</a>
                                        <a href="bs-mercadopagosettings.php">Mercado Pago</a>
                                    </div>
                                </ul>
                            </li>
