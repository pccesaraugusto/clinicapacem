     ...
     */
      ...
      **/
       ...
       **/
        ...
        /**
        * Metodo responsavel por definir o valor de $marchatName
        * @param string $marchatName
        **/
         ...
         /**
        * Metodo responsavel por definir o valor de $marchatCity
        * @param string $marchatCity
        **/
         ...
         **/
          ...
          **/
           private function getValue($id, $value){
              $size = str_pad(strlen($value), 2, '0', STR_PAD_LEFT); //-- para adicionar zeros a esquerda da string --//
           ...
           **/
           ...
           /**
           * Metodo responsavel por retornar os valores completos do campo adicional do pix
           * @return string
           **/
