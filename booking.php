			...
			<table width="650" class="booking_form">
				<tr>
					...
					<td align="left" style="padding-left:10px">
						<textarea name="comments" placeholder="Adicione um comentário." id="comments" cols="15" rows="3" onchange="checkFieldBack(this)" style=" width: 400px; height: 50px; resize: none;"><?php echo $comments ?></textarea>

						<span><?php echo LB_OPCOES_SELECT; ?>*:&nbsp;</span>
						<select name="tipopgto" id="tipopgto" onchange="checkFieldBack(this);">
							<option value="">Selecione</option>
							<option value="mercadopago"><?php echo SELECT_MERCADO_PAGO; ?></option>
							<option value="paypal"><?php echo SELECT_PAYPAL; ?></option>
							<option value="pix"><?php echo SELECT_PIX; ?></option>
						</select>
